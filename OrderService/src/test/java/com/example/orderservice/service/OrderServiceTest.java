...
class OrderServiceTest {
    ...
    void startOrderTest() {
        ...
        // then
        assertNotNull(startOrderResponseDto.getOrderId());
        assertEquals(paymentMethodRes, startOrderResponseDto.getPaymentMethod());
        assertEquals(userAddressRes, startOrderResponseDto.getAddress());

        var order = orderRepository.findById(startOrderResponseDto.getOrderId());
